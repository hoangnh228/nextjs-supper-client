...
import { useGetOrdersQuery, useUpdateOrderMutation } from '@/queries/useOrder'
...
export default function OrderTable() {
  ...
  const refechOrderList = orderListQuery.refetch
  ...
  }, [refechOrderList, fromDate, toDate, socket])
